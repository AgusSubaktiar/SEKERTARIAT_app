                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modelTambahSmu">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($surat_masukus as $row) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" data-toggle="modal" data-target="#modelSuratmu" id="btn-editsmu" class="btn btn-sm btn-warning" data-id="<?= $row['id']; ?>" data-proyek="<?= $row['proyek']; ?>" data-kontak="<?= $row['kontak']; ?>" data-tgl_surat="<?= $row['tgl_surat']; ?>" data-no_surat="<?= $row['no_surat']; ?>" data-dibuat="<?= $row['dibuat']; ?>" data-hal="<?= $row['hal']; ?>" data-kerahasiaan="<?= $row['kerahasiaan']; ?>" data-urgensi="<?= $row['urgensi']; ?>" data-ordner="<?= $row['ordner']; ?>"> <i class="fas fa-edit"></i></button>
                                                    <button type="button" data-toggle="modal" data-target="#modelHapusMu" class="btn btn-sm btn-danger"> <i class="fas fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
                                            <?php $no++; ?>
                                        <?php endforeach; ?>
...
<!-- Modal Tambah Surat-->
<div class="modal fade" id="modelTambahSmu">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('SuratMasukU/addSuratmu'); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="addSuratmu" class="btn btn-primary">Tambah Data</button>
            </div>
            </form>
        </div>
    </div>
...
<!-- Modal Edit Surat-->
<div class="modal fade" id="modelSuratmu">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="<?= base_url('SuratMasukU/ubahm'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group mb-1">
                        <input type="hidden" name="id" id="id-surat_masuku">
                        <label for="proyek"></label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="submit" name="ubahm" class="btn btn-primary">Edit Data</button>
            </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="modelHapusMu">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a href="/SuratMasukU/hapusmu/<?= $row['id']; ?>" class="btn btn-primary">Yakin</a>
            </div>
        </div>
    </div>
</div>
