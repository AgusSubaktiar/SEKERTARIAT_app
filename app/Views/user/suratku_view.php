                                        ...
                                        foreach ($surat_keluar as $row) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" data-toggle="modal" data-target="#modelHapusSk" class="btn btn-sm btn-danger"> <i class="fas fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
                                            <?php $no++; ?>
                                        <?php endforeach; ?>
...
<!-- Modal Tambah Surat-->
<div class="modal fade" id="modelTambahSk">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('SuratKeluar/addSuratsk'); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="addSuratsk" class="btn btn-primary">Tambah Data</button>
            </div>
            </form>
        </div>
    </div>
...
<!-- Modal Edit Surat-->
<div class="modal fade" id="modelUbahSk">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="<?= base_url('SuratKeluar/ubahsk'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group mb-1">
                        <input type="hidden" name="id" id="id-surat_keluar">
                        <label for="proyek"></label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="submit" name="ubahsk" class="btn btn-primary">Edit Data</button>
            </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="modelHapusSk">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a href="/SuratKeluar/hapussk/<?= $row['id']; ?>" class="btn btn-primary">Yakin</a>
            </div>
        </div>
    </div>
</div>
