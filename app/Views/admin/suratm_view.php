    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('SuratMasuk/addSuratmu'); ?>" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="modelSuratmu">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('SuratMasuk/ubahm'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group mb-1">
...
<div class="modal fade" id="modelHapusMu">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a href="/SuratMasuk/hapusmu/<?= $row['id']; ?>" class="btn btn-primary">Yakin</a>
            </div>
        </div>
    </div>
</div>
