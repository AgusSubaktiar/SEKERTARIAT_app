...
class SuratMasukU extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'surat_masukus' => $this->model->paginate('2'),
            'pager' => $this->model->pager
        ];
        echo view('user/suratMu', $data);
    }
    public function addSuratmu()
    {
        if (isset($_POST['addSuratmu'])) {
            ...
            if (!$val) {
                ...
                $data['surat_masukus'] = $this->model->getdata('suratmasukus')->result();
                ...
                if ($success) {
                    ...
                    return redirect()->to(base_url('SuratMasukU'));
                }
            }
        } else {
            return redirect()->to('SuratMasukU');
            dd('berhasil');
        }
    }
